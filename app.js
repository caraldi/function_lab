...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  console.log('Sum message:', sumMessage);
...
function sumArray(testArray){ //eslint-disable-line
  ...
  var arrayMessage = 2 + ',' + 3 + ',' + 4 + ' was passed in as an array of numbers, and ' + arraySum + ' is their sum.';
  console.log('Array message:', arrayMessage);
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  var arrayMessage = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + arrayProduct + '.';
  console.log('Array message:', arrayMessage);
  return [arrayProduct, arrayMessage];
}
